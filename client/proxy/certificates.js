...
function generateCertificate(servername) {
    ...
    const privateCAKey = pki.privateKeyFromPem(fs.readFileSync('./client/proxy/certs/ca.key'));
    const caCert = pki.certificateFromPem(fs.readFileSync('./client/proxy/certs/ca.crt'));
