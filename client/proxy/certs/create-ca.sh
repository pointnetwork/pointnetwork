#!/usr/bin/env bash
# from: https://github.com/BenMorel/dev-certificates
...
openssl req -x509 -new -nodes -subj "/C=US/O=_Point ZProxy CA/CN=Development certificates" -key ca.key -sha256 -days 36500 -out ca.crt
