...
contract StorageProviderRegistry {
    ...
    event Announcement(address id, string connection, uint collateral, uint collateral_lock_period);

    function announce(string memory connection, uint collateral_lock_period) payable public {
        ...
        emit Announcement(msg.sender, connection, sp.collateral, sp.collateral_lock_period);
    }
