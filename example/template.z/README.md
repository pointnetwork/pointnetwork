...
1. CD into the [./example/template.z](./example/template.z) directory.
...
1. Run `./scripts/deploy-sites.sh template.z --contracts` (from the node root folder) to deploy the sites `views` directory that was built using parcel.
