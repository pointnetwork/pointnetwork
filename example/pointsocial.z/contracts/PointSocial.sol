...
contract PointSocial  {
    ...
    function _init(uint i) public {
        ...
        if (i == 1 && _postIds.current() < i) {
            ...
            commentsByPost[1].push(_comment);
            ...
            _postIds.increment();
        } else if (i == 2 && _postIds.current() < i) {
            Post memory _post = Post({
                id: 2,
            ...
            postById[_post.id] = _post;
            _postIds.increment();
        } else if (i == 3 && _postIds.current() < i) {
            Post memory _post = Post({
                id: 3,
                from: 0x2d5360AAb543E92efc40B438b813f0FD5fa64620,
            ...
            postById[_post.id] = _post;
            _postIds.increment();
        } else if (i == 4 && _postIds.current() < i) {
            Post memory _post = Post({
                id: 4,
            ...
            postById[_post.id] = _post;
            _postIds.increment();
        } else if (i == 5 && _postIds.current() < i) {
            // comment 2 on post 5
            Comment memory _comment = Comment({
                id: 2,
            ...
            commentsByPost[5].push(_comment);
            commentById[_comment.id] = _comment;
            commentsByOwner[_comment.from].push(_comment);
            _commentIds.increment();
            ...
            postById[_post.id] = _post;
            _postIds.increment();
        } else if (i == 6 && _postIds.current() < i) {
            // comment 3 on post 6
            Comment memory _comment = Comment({
                id: 3,
            ...
            commentsByPost[6].push(_comment);
            commentById[_comment.id] = _comment;
            commentsByOwner[_comment.from].push(_comment);
            _commentIds.increment();
            ...
            postById[_post.id] = _post;
            _postIds.increment();
        } else if (i == 7 && _postIds.current() < i) {
            Post memory _post = Post({
                id: 7,
            ...
            postById[_post.id] = _post;
            _postIds.increment();
        } else if (i == 8 && _postIds.current() < i) {
            Post memory _post = Post({
                id: 8,
                from: 0x8690481754AaFF7f6cC51EeA188a1903C5E451b4,
            ...
            postById[_post.id] = _post;
            _postIds.increment();
        } else if (i == 9 && _postIds.current() < i) {
            Post memory _post = Post({
                id: 9,
                from: 0x8690481754AaFF7f6cC51EeA188a1903C5E451b4,
            ...
            postById[_post.id] = _post;
            _postIds.increment();
        } else if (i == 10 && _postIds.current() < i) {
            Post memory _post = Post({
                id: 10,
            ...
            postById[_post.id] = _post;
            _postIds.increment();
        } else if (i == 11 && _postIds.current() < i) {
            Post memory _post = Post({
                id: 11,
            ...
            postById[_post.id] = _post;
            _postIds.increment();
        } else if (i == 12 && _postIds.current() < i) {
            Post memory _post = Post({
                id: 12,
                from: 0x314dF55775e0b6F2B0c6d07C7Ec83a3e1cdC165e,
            ...
            postById[_post.id] = _post;
            _postIds.increment();
        } else if (i == 13 && _postIds.current() < i) {
            Post memory _post = Post({
                id: 13,
            ...
            postById[_post.id] = _post;
            _postIds.increment();
        } else if (i == 14 && _postIds.current() < i) {
            Post memory _post = Post({
                id: 14,
