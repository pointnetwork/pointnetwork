...
1. CD into the [./example/store.point/](./example/store.point/) directory.
...
1. Run `./scripts/deploy-sites.sh store.point --contracts` (from the node root folder) to deploy the sites `views` directory that was built using parcel.
