...
// const SUBSCRIPTION_CONTRACT_ID = config.get(`network.web3.${DEFAULT_NETWORK}.identity_contract_id`);
const SUBSCRIPTION_CONTRACT_ADDRESS = config.get(
  `network.web3.${DEFAULT_NETWORK}.subscription_contract_address`
);
