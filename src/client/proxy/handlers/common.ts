...
import {readFileByPath, splitAndTakeLastPart, getFullPathFromLocalRoot} from '../../../util/index.js';
import {FastifyInstance, FastifyReply, FastifyRequest} from 'fastify';
import ZProxySocketController from '../../../api/sockets/ZProxySocketController.js';
import {SocketStream} from 'fastify-websocket';
const Renderer = require('../../zweb/renderer/index.js');
import logger from '../../../core/log.js';
const blockchain = require('../../../network/providers/ethereum.js');
import {getContentTypeFromExt, matchRouteAndParams} from '../proxyUtils.js';
//// @ts-expect-error no types for package
// import detectContentType from 'detect-content-type';
import config from 'config';
import {Template, templateManager} from '../templateManager.js';
import {getMirrorWeb2Page} from './mirror.js';
import {parseDomainRegistry} from '../../../name_service/registry.js';
import {HttpForbiddenError, HttpNotFoundError} from '../../../core/exceptions.js';
import csrfTokens from '../../zweb/renderer/csrfTokens.js';
import {randomBytes} from 'crypto';
import {getIPFSFileAsStream, getIPFSPeers, getIPFSPubsubPeers} from '../../storage/ipfs.js';
const {getJSON, getFileIdByPath, getFile, getFileAsReadStream} = require('../../storage/index.js');
