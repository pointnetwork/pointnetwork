...
import {readFileByPath, splitAndTakeLastPart, getFullPathFromLocalRoot} from '../../../util/index';
import {FastifyInstance, FastifyReply, FastifyRequest} from 'fastify';
import ZProxySocketController from '../../../api/sockets/ZProxySocketController';
import {SocketStream} from 'fastify-websocket';
const Renderer = require('../../zweb/renderer/index');
...
const {getJSON, getFileIdByPath, getFile, getFileAsReadStream} = require('../../storage/index');
